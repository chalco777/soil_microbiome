...
# Directorios base
BED_DIR="/media/crowfoot2/DATOS/LIG_P2/results/rgi_D_beds"
ALIGNMENT_DIR="/media/crowfoot2/DATOS/LIG_P2/results/minimap_result"
FAI_DIR="/media/crowfoot2/DATOS/LIG_P2/results/DS_flye"
OUTPUT_DIR="/media/crowfoot2/DATOS/LIG_P2/results/count_bedtools"
